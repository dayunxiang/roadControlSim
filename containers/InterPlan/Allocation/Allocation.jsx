...
import { Select, Radio, Icon, Progress, message, DatePicker, Checkbox } from 'antd'
import moment from 'moment'
import styles from './Allocation.scss'
...
class Allocation extends React.Component {
  ...
  componentDidMount = () => {
    if (this.InterPlanMsg.nodeId) {
      this.paramerDetail.targetId = this.InterPlanMsg.nodeId
      ...
      this.paramerDetail.fileName = this.InterPlanMsg.nodeId.toString() + this.InterPlanMsg.planMsg.geometryId + this.InterPlanMsg.planMsg.flowId + this.InterPlanMsg.planMsg.stpId
    }
    this.getdrivingType()
    this.getsimparam()
  }
  ...
  // 保存的回调
  handleSavePlan = () => {
    // console.log(this.paramerDetail);
    ...
    if ((this.paramerDetail.simStep < 1) && (this.paramerDetail.simStepTo)) {
  ...
  render() {
    const { Option } = Select
    const {
      paramerDetailInfo, hiddenSave, paramerDetail, drivingType, progress,
    } = this.state
    return (
      <div className={styles.evaluateWrapper}>
        <Header handleSavePlan={this.handleSavePlan} hiddenSave={hiddenSave} InterName={this.InterPlanMsg.interName} />
        <div className={styles.evaluateBox}>
          <div className={styles.planListBox}>
            {/* <AddPlanList planList={[1, 2]} /> */}
            ...
            <div className={styles.settingBox}>
              ...
              <div className={styles.setItemsBox}>
                <div className={styles.setItems}>
                  <span>仿真开始时间：</span>
                  {paramerDetail ? <DatePicker showTime style={{ width: 120 }} placeholder="请选择日期" defaultValue={moment(paramerDetail ? paramerDetail.simDate : this.getNowFormatDate(), dateFormat)} format={dateFormat} onChange={this.handleChangeTime} /> : '加载中...'}
                </div>
                <div className={styles.setItems}>
                  <span>仿真时长：</span>
            ...
            <div className={styles.driveParams}>
              ...
              <div className={styles.setItemsBox}>
                ...
                <div className={styles.setItems}>
                  ...
                  <span className={styles.Itemcengaaa} />
